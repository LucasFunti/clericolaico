                    ...
                    <ul key={`${speaker}_${speakerIndex}`} role="list" className="mt-2 space-y-8 text-slate-500">
                      {speaker.items.map(({title, text})=> {
                          ...
                          <li className="flex flex-wrap gap-x-3">
                            <svg className="mt-1 h-5 w-5 flex-none text-blue-200" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                              <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                              <g id="SVGRepo_iconCarrier"> 
                                <rect width="24" height="24" fill="white"></rect> 
                                <path d="M5 13.3636L8.03559 16.3204C8.42388 16.6986 9.04279 16.6986 9.43108 16.3204L19 7" stroke="#000000" strokeLinecap="round" strokeLinejoin="round"></path> 
                              </g>
                            </svg>                      
                            <strong className="font-semibold text-blue-900">{t(title)}</strong> 
                            <span>{t(text)}</span>
                          </li>
                          </>
                      })}
